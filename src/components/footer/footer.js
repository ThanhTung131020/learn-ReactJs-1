        ...
        <div style={{ backgroundColor: 'black', height: 600 }}>
            <div>
                <div className='d-flex' style={{ color: 'white' }}>
                    <div className='col-md-3' style={{ marginLeft: 100, marginRight: 30, marginTop: 50, marginBottom: 100 }}>
                        ...
                        <div className='d-flex'  >
                            <div className='col-md-4 d-flex' style={{ background: 'grey', width: 50, height: 50, borderRadius: 100, marginRight: 20, justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <div className='col-md-3' style={{ marginTop: 50, }}>
                        ...
                        <div className='d-flex'>
                            ...
                            <p style={{ width: 200 }}>	203 Fake St. Mountain View, San Francisco, California, USA</p>
                ...
                <div style={{ textAlign: 'center' }}>
                    <p style={{ fontSize: 18, color: '#999999' }}>Copyright ©2023 All rights reserved | This template is made with  by Colorlib</p>
                </div>
            </div>
